...
# ========================================================
class ImageClient:
    def __init__(self, host="127.0.0.1", request_port=60001): #host="192.168.123.164"
        """
        Args:
...
def main():
    ...
    parser.add_argument('--host', type=str, default='127.0.0.1', help='IP address of image server') # default='192.168.123.164'
